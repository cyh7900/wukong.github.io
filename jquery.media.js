...
$.fn.Play = function(ObjectId){
	...
	var MovieObject = getMovieObject(ObjectId);//��ȡ��ǰ��������ID
...
$.fn.media.defaults = {
	...
	playerid:	'MyPlayer',	// object control ID
...
$.fn.media.defaults.players = {
	...
	realplayer: {
		name:		  'real',
		title:		  'RealPlayer',
		types:		  'ra,ram,rm,rmvb,rpm,rv,smi,smil',
...
function generate(el, opts, player) {
	...
	if (player == 'iframe') {
		...
		var a = ['<object id="'+opts.playerid+'" width="' + opts.width + '" height="' + opts.height + '" '];
		...
		var a = ['<object id="'+opts.playerid+'" type="' + o.mimetype +'" width="' + opts.width + '" height="' + opts.height +'"'];
		...
		a.push('</ob'+'ject'+'>');
	        ...
	        var a = ['<embed id="'+opts.playerid+'" width="' + opts.width + '" height="' + opts.height + '" style="display:block"'];
